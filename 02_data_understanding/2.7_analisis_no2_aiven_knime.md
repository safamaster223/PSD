...
> **Panduan Gambar 02 (`data/images/analisis_no2/02-python-ingestion-log.png`):** Tangkapan layar terminal yang menampilkan log sukses pengunggahan tabel mentah, tabel bersih, dan tabel analisis `wonoayu_no2`.
...
> **Panduan Gambar 09 (`data/images/analisis_no2/09-knime-statistics-table-output.png`):** Tangkapan layar tampilan tabel hasil eksekusi node `Statistics` KNIME untuk kolom `no2` data riil Kecamatan Wonoayu (Missing: 126, Overall Sum: 0.01, Skewness: 0.732, Kurtosis: 2.848).
